...
const announcements: Announcement[] = [
  {
    ...
    content: "The ivory trade ban in 1989 is credited with significantly reducing elephant poaching, at least for a period. Helped reduce trade in certain whale species alongside the International Whaling Commission. Cracked down on the exotic bird trade significantly in the 1990s. Listing of certain shark species has helped raise awareness and regulation around fin trading.",
    type: "info",
    date: "Today",
    author: "CITES Info",
  },
  {
    id: 2,
    title: "Limitations Though",
    content: "CITES only covers international trade — it doesn't regulate domestic trade within a country, which can be a major loophole. Enforcement is uneven — some countries lack the capacity or political will to police wildlife trade at their borders. Illegal wildlife trade remains a massive global problem despite CITES — it's estimated to be worth up to $23 billion annually. There are ongoing debates about whether certain species should be up or downlisted, often influenced by political and economic interests. It doesn't address habitat destruction, which is arguably a bigger driver of species loss than trade.",
    type: "urgent",
    date: "Today",
    author: "CITES Alert",
  },
