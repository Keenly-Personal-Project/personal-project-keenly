...
const PasswordResetCodeEmail = ({ code = 'A4F2B1' }: ResetCodeProps) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Use the code below to reset your {SITE_NAME} password. This code expires in 10 minutes.
        </Text>
...
export const template = {
  ...
  subject: 'Your Keenly password reset code',
